      ...
      <div className="container col-md-4 card rounded-7 me-lg-n5 py-3">
          ...
          <form>
              <div className="row">
                  ...
                  <div class="mb-3">
                    <button to="/login" type="submit" className="btn btn-outline-primary col-12">Sign Up</button>
                  </div>
              </div>
          </form>
          <div className="login">
              <p>Already have an account?  <Link to="/login" type="submit" className="">Login</Link>
              </p>
          </div>
      </div>
    </div>
